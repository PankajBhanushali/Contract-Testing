...
namespace Consumer
{
    public class ApiClient
    {
        ...
        public async Task<HttpResponseMessage> GetAllProducts(bool includeAuth = false)
        {
        ...
        public async Task<HttpResponseMessage> GetProduct(int id, bool includeAuth = false)
        {
            using (var client = new HttpClient { BaseAddress = BaseUri })
            {
                try
